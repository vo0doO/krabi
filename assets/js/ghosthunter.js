...
(function( $ ) {
	...
	var pluginMethods	= {
      ...
      */
        ...
        var url = site_url + "/ghost/api/v3/content/posts/?key=" + search_api_key + "&limit=all&fields=id,title,excerpt,url,created_at,feature_image,visibility&formats=plaintext";
      ...
      $.get(url).done(function(data) {
        searchData = data.posts;
            ...
            excerpt: String(arrayItem.excerpt),
            ...
            featureImage: String(arrayItem.feature_image),
					...
					blogData[arrayItem.id] = {title: arrayItem.title, excerpt: arrayItem.excerpt, pubDate: tempdate, link: arrayItem.url, featureImage: arrayItem.feature_image};
				});
      });
			this.isInit = true;
		},
